...
<nav class="navbar navbar-expand-lg navbar-dark">
  <!-- logo -->
  <a href="index.php"></a><img class="logo-sm" src="img/VAVE-logo.svg" alt="">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <main>
                ...
                <p>Try to finde one sentence or two to describe the concept of your page. Sports and camps describe a mood to make people feel whatever bla bla.</p>
                <button>join a training</button>
            </main>
          </div>
          <div class="col-lg-4">
    ...
    <div class="container">
        <div class="row">
          ...
          <div class="col-lg-10">
            <section>
                <h4>Gallery</h4>
                <h2>Something about your Gallery Loerum ipsum dolor sit.</h2>
          ...
          <div class="col-lg-6">
            <section>
                <h4>Events</h4>
                    ...
                    <div class="flexer">
                        <button><a href=""></a>Get your ticket</button>
                        <p>just 3 tickets left</p>
                    </div> 
            </section>
          </div>
          <div class="col-lg-1"></div>
